...
public interface OrderTotalPostProcessorModule extends Module {
  ...
  /**
   * Uses the OrderSummary and external tools for applying if necessary variations on the OrderTotal
   * calculation.
   *
   ...
   */
  OrderTotal caculateProductPiceVariation(final OrderSummary summary,
      final ShoppingCartItem shoppingCartItem, final Product product, final Customer customer,
