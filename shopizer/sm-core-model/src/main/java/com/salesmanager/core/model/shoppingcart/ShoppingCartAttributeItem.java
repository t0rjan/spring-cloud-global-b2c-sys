...
public class ShoppingCartAttributeItem extends
    SalesManagerEntity<Long, ShoppingCartAttributeItem> implements Auditable {
  ...
  public ShoppingCartAttributeItem(ShoppingCartItem shoppingCartItem,
