...
public class ProductManagementAPITest {
  ...
  /**
   * Creates a Manufacturer reference object that can be used when creating a product
   */
  @Test
  @Ignore
...
/*		{
    ...
    ResponseEntity response = restTemplate
        .postForEntity("http://localhost:8080/sm-shop/services/private/DEFAULT/manufacturer",
            entity, PersistableManufacturer.class);
  ...
  public void createProductReview() throws Exception {
    ...
    ResponseEntity response = restTemplate
        .postForEntity("http://localhost:8080/sm-shop/services/private/DEFAULT/product/review",
            entity, PersistableProductReview.class);
  ...
  public void createOptionValue() throws Exception {
    ...
    ResponseEntity response = restTemplate
        .postForEntity("http://localhost:8080/sm-shop/services/private/DEFAULT/product/optionValue",
            entity, PersistableProductOptionValue.class);
  ...
  public void createOption() throws Exception {
    ...
    ResponseEntity response = restTemplate
        .postForEntity("http://localhost:8080/sm-shop/services/private/DEFAULT/product/option",
            entity, PersistableProductOption.class);
  ...
  public void getProducts() throws Exception {
    ...
    ResponseEntity<ReadableProduct[]> response = restTemplate.exchange(
  ...
  public void postProduct() throws Exception {
    ...
    ResponseEntity response = restTemplate
        .postForEntity("http://localhost:8080/api/v1/product", entity, PersistableProduct.class);
