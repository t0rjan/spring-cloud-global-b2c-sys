...
public class CategoryManagementAPITest {
  ...
  public void getCategory() throws Exception {
    ...
    ResponseEntity<ReadableCategory> response = restTemplate
        .exchange("http://localhost:8080/sm-shop/services/public/DEFAULT/category/100?lang=en",
            HttpMethod.GET, httpEntity, ReadableCategory.class);
  ...
  public void postCategory() throws Exception {
    ...
    ResponseEntity response = restTemplate
        .postForEntity("http://localhost:8080/sm-shop/services/private/DEFAULT/category", entity,
  ...
  public void deleteCategory() throws Exception {
    ...
    restTemplate
        .exchange("http://localhost:8080/sm-shop/services/DEFAULT/category/100", HttpMethod.DELETE,
            httpEntity, Category.class);
