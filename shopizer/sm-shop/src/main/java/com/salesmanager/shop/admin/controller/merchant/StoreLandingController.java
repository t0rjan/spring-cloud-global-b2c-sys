...
public class StoreLandingController {
  ...
  public String displayStoreLanding(Model model, HttpServletRequest request,
  ...
  public String saveStoreLanding(@Valid @ModelAttribute("storeLanding") StoreLanding storeLanding,
