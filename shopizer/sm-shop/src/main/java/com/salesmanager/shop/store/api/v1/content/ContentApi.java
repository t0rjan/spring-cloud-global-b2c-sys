...
public class ContentApi {
  ...
  @ResponseBody
  public List<ReadableContentPage> pages(HttpServletRequest request, HttpServletResponse response)
      throws Exception {
  ...
  @ResponseBody
  public List<ReadableContentBox> pagesSummary(HttpServletRequest request,
    ...
    try {
      ...
      List<ReadableContentBox> boxes = contentFacade
          .boxes(ContentType.BOX, "summary_", merchantStore, language);
  ...
  @ResponseBody
  public ReadableContentPage page(@RequestParam("code") String code, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  @ResponseBody
  public ReadableContentBox box(@PathVariable("code") String code, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  @ResponseBody
  public HttpEntity<String> upload(@Valid @RequestBody ContentFile file, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
  public ResponseEntity<Void> delete(@Valid @RequestBody ContentName name,
      HttpServletRequest request, HttpServletResponse response) throws Exception {
