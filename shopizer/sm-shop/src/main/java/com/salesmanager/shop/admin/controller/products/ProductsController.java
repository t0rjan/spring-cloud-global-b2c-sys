...
public class ProductsController {
  ...
  public String displayProducts(Model model, HttpServletRequest request,
  ...
  public @ResponseBody
  ResponseEntity<String> deleteProduct(HttpServletRequest request, HttpServletResponse response,
      Locale locale) {
