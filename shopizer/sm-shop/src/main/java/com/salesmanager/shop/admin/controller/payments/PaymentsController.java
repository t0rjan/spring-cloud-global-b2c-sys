...
public class PaymentsController {
  ...
  public String displayPaymentMethod(@RequestParam("code") String code, Model model,
  ...
  public String deletePaymentMethod(@RequestParam("code") String code, Model model,
