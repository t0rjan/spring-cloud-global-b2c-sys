...
public class TaxConfigurationController {
  ...
  public String displayTaxConfiguration(Model model, HttpServletRequest request,
  ...
  public String saveTaxConfiguration(
      @Valid @ModelAttribute("taxConfiguration") TaxConfiguration taxConfiguration,
