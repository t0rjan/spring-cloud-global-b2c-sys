...
public class ProductReviewApi {
  ...
  @ResponseBody
  public List<ReadableProductReview> getAll(@PathVariable final Long id, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
    ...
    try {
      ...
      List<ReadableProductReview> reviews = productFacade
          .getProductReviews(product, merchantStore, language);
  ...
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
  public PersistableProductReview update(@PathVariable final Long id,
      @PathVariable final Long reviewId, @Valid @RequestBody PersistableProductReview review,
