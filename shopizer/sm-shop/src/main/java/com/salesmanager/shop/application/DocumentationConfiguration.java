...
public class DocumentationConfiguration {
  ...
  /**
   * Artifact's name from the pom.xml file buildProperties.getName(); // Artifact version
   * buildProperties.getVersion(); // Date and Time of the build buildProperties.getTime(); //
   * Artifact ID from the pom file buildProperties.getArtifact(); // Group ID from the pom file
