...
public class ContentBoxesController {
  ...
  public String listContentBoxes(Model model, HttpServletRequest request,
  ...
  public String createBox(Model model, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    model.addAttribute("boxes", true);
    setMenu(model, request);
