...
public class CustomerProductReviewController extends AbstractController {
  ...
  public String displayProductReview(@RequestParam Long productId, Model model,
    ...
    /** template **/
    StringBuilder template = new StringBuilder().append(ControllerConstants.Tiles.Customer.review)
