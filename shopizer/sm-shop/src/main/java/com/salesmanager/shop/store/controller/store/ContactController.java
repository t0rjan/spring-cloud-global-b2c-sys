...
public class ContactController extends AbstractController {
  ...
  public String displayContact(Model model, HttpServletRequest request,
    ...
    /** template **/
    StringBuilder template = new StringBuilder().append(ControllerConstants.Tiles.Content.contactus)
  ...
  public @ResponseBody
  String sendEmail(@ModelAttribute(value = "contact") ContactForm contact,
...
/*	        if ( StringUtils.isNotBlank( contact.getCaptchaChallengeField() )
      ...
      emailTemplatesUtils
          .sendContactEmail(contact, store, LocaleUtils.getLocale(store.getDefaultLanguage()),
