...
public class CustomProductGroupsController {
  ...
  public String displayProductGroups(Model model, HttpServletRequest request,
  ...
  public @ResponseBody
  ResponseEntity<String> pageCustomGroups(HttpServletRequest request,
  ...
  public String saveCustomProductGroup(@ModelAttribute("group") ProductRelationship group,
    ...
    if (StringUtils.isBlank(group.getCode())) {
      FieldError fieldError = new FieldError("group", "code", group.getCode(), false, null, null,
          messages.getMessage("message.group.required", locale));
    ...
    for (ProductRelationship grp : groups) {
      if (grp.getCode().equalsIgnoreCase(group.getCode())) {
        ...
        FieldError fieldError = new FieldError("group", "code", group.getCode(), false, messages,
            args, null);
        result.addError(fieldError);
      }
    }
  ...
  public @ResponseBody
  ResponseEntity<String> removeCustomProductGroup(HttpServletRequest request,
      HttpServletResponse response) {
  ...
  public @ResponseBody
  ResponseEntity<String> activateProductGroup(HttpServletRequest request,
      HttpServletResponse response) {
  ...
  public String displayCustomProductGroup(@RequestParam("id") String groupCode, Model model,
  ...
  ResponseEntity<String> pageProducts(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      List<ProductRelationship> relationships = productRelationshipService
          .getByGroup(store, code, language);
