...
public class RelatedItemsController {
  ...
  public String displayRelatedItems(@RequestParam("id") long productId, Model model,
  ...
  public @ResponseBody
  ResponseEntity<String> pageRelatedItems(HttpServletRequest request,
    ...
    try {
      ...
      List<ProductRelationship> relationships = productRelationshipService
          .getByType(store, product, ProductRelationshipType.RELATED_ITEM, language);
  ...
  ResponseEntity<String> removeItem(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      List<ProductRelationship> relationships = productRelationshipService
          .getByType(store, baseProduct, ProductRelationshipType.RELATED_ITEM);
