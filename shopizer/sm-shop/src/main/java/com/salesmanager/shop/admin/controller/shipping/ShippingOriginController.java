...
public class ShippingOriginController {
  ...
  public String displayShippingOrigin(Model model, HttpServletRequest request,
  ...
  public String saveShippingOrigin(@Valid @ModelAttribute("origin") ShippingOrigin origin,
  ...
  public String deleteShippingOrigin(@ModelAttribute("origin") ShippingOrigin origin, Model model,
