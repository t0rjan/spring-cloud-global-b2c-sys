...
public class CustomerApi {
  ...
  public @ResponseBody
  PersistableCustomer update(@PathVariable Long id,
  ...
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
  public ReadableCustomer get(@PathVariable Long id, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public ReadableCustomer get(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      ReadableCustomer customer = customerFacade
          .getCustomerById(c.getId(), merchantStore, language);
      if (customer == null) {
