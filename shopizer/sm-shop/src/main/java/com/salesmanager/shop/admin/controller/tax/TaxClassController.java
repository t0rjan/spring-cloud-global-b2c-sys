...
public class TaxClassController {
  ...
  public String displayTaxClasses(Model model, HttpServletRequest request,
  ...
  public String saveTaxClass(@Valid @ModelAttribute("taxClass") TaxClass taxClass,
    ...
    if (taxClass.getCode().equals(TaxClass.DEFAULT_TAX_CLASS)) {
      ObjectError error = new ObjectError("code",
          messages.getMessage("message.taxclass.alreadyexist", locale));
  ...
  public String updateTaxClass(@Valid @ModelAttribute("taxClass") TaxClass taxClass,
      BindingResult result, Model model, HttpServletRequest request, Locale locale)
      throws Exception {
  ...
  public @ResponseBody
  ResponseEntity<String> removeTaxClass(HttpServletRequest request, Locale locale)
      throws Exception {
  ...
  public String editTaxClass(@ModelAttribute("id") String id, Model model,
