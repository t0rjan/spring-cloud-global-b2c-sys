...
public class ProductGroupApi {
  ...
  @ResponseBody
  public ReadableProductList getProductItemsByGroup(@PathVariable final String code,
  ...
  public @ResponseBody
  ReadableProductList addProductToGroup(@PathVariable Long productId, @PathVariable String code,
    ...
    try {
      ...
      ReadableProductList list = productItemsFacade
          .addItemToGroup(product, code, merchantStore, language);
  ...
  public @ResponseBody
  ReadableProductList removeProductFromCategory(@PathVariable Long productId,
    ...
    try {
      ...
      ReadableProductList list = productItemsFacade
          .removeItemFromGroup(product, code, merchantStore, language);
