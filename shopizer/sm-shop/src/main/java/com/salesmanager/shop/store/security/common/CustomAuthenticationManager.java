...
/**
 * Abstract authentication manager to be used by various internal Authentication manager invoked
 * from a SecurityFilter placed in the security filter chain of given http configuration.
 *
 * @author c.samson
 */
public abstract class CustomAuthenticationManager {
  ...
  private void unsuccess(HttpServletRequest request, HttpServletResponse response)
  ...
  public abstract void successfullAuthentication(HttpServletRequest request,
      HttpServletResponse response, Authentication authentication) throws AuthenticationException;

  public abstract void unSuccessfullAuthentication(HttpServletRequest request,
