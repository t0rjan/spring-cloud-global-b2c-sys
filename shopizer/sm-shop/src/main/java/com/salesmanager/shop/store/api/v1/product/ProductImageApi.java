...
public class ProductImageApi {
  ...
  public @ResponseBody
  PersistableImage createImage(@PathVariable Long id, @Valid @RequestBody PersistableImage image,
  ...
  public void deleteImage(@PathVariable Long id, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
