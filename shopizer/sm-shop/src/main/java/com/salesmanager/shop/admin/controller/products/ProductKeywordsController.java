...
public class ProductKeywordsController {
  ...
  public String displayKeywords(@RequestParam("id") long productId, Model model,
  ...
  public String addKeyword(@Valid @ModelAttribute("productKeyword") Keyword keyword,
    ...
    if (productDescription == null) {
      FieldError error = new FieldError("keyword", "keyword",
          messages.getMessage("message.product.language", locale));
  ...
  public @ResponseBody
  ResponseEntity<String> removeKeyword(@RequestParam("id") long productId,
