...
public class OrderPaymentApi {
  ...
  public ReadableTransaction init(
    ...
    try {
      ...
      Transaction transactionModel = paymentService
          .initTransaction(customer, paymentModel, merchantStore);
  ...
  public ReadableOrderList listCapturableOrders(
    ...
    try {
      ...
      ReadableOrderList returnList = orderFacade
          .getCapturableOrderList(merchantStore, sDate, eDate, language);
  ...
  public ReadableTransaction caprurePayment(
    ...
    try {
      ...
      ReadableTransaction transaction = orderFacade
          .captureOrder(merchantStore, order, customer, language);
