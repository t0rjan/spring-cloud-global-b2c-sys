...
public class ShoppingCartApi {
  ...
  public @ResponseBody
  ReadableShoppingCart addToCart(@Valid @RequestBody PersistableShoppingCartItem shoppingCartItem,
    ...
    try {
      ...
      ReadableShoppingCart cart = shoppingCartFacade
          .addToCart(shoppingCartItem, merchantStore, language);
  ...
  public @ResponseBody
  ReadableShoppingCart modifyCart(@PathVariable String code,
      @Valid @RequestBody PersistableShoppingCartItem shoppingCartItem, HttpServletRequest request,
    ...
    try {
      ...
      ReadableShoppingCart cart = shoppingCartFacade
          .addToCart(code, shoppingCartItem, merchantStore, language);
  ...
  public @ResponseBody
  ReadableShoppingCart getByCode(@PathVariable String code, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  ReadableShoppingCart addToCart(@PathVariable Long id,
    ...
    try {
      ...
      ReadableShoppingCart cart = shoppingCartFacade
          .addToCart(customer, shoppingCartItem, merchantStore, language);
  ...
  public @ResponseBody
  ReadableShoppingCart get(@PathVariable Long id, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
