...
public class GroupsController {
  ...
  public String save(@Valid @ModelAttribute("group") GroupDetails group, BindingResult result,
    ...
    if (g != null) {
      ObjectError error = new ObjectError("group.groupName",
          messages.getMessage("message.name.exist", locale));
  ...
  ResponseEntity<String> pageGroups(HttpServletRequest request,
    ...
    try {
      ...
      for (Group group : groups) {
        ...
        StringBuilder key = new StringBuilder().append("security.group.description.")
