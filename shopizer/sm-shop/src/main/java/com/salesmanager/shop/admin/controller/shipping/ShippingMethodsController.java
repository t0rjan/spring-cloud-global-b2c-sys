...
public class ShippingMethodsController {
  ...
  public String displayShippingMethods(Model model, HttpServletRequest request,
  ...
  public String displayShippingMethod(@RequestParam("code") String code, Model model,
  ...
  public String saveShippingMethod(
      @ModelAttribute("configuration") IntegrationConfiguration configuration, BindingResult result,
  ...
  public String saveCustomWeightBasedShippingMethod(
  ...
  public String deleteShippingMethod(@RequestParam("code") String code, Model model,
