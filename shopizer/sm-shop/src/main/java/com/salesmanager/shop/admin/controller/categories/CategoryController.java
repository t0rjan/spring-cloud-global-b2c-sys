...
public class CategoryController {
  ...
  public String displayCategoryEdit(@RequestParam("id") long categoryId, Model model,
  ...
  public String displayCategoryCreate(Model model, HttpServletRequest request,
  ...
  private String displayCategory(Long categoryId, Model model, HttpServletRequest request,
    ...
    if (categoryId != null && categoryId != 0) {//edit mode
      ...
      if (category == null || category.getMerchantStore().getId().intValue() != store.getId()
          .intValue()) {
  ...
  public String saveCategory(@Valid @ModelAttribute("category") Category category,
    ...
    if (category.getId() != null && category.getId() > 0) { //edit entry
      ...
      if (currentCategory == null || currentCategory.getMerchantStore().getId().intValue() != store
          .getId().intValue()) {
        return "catalogue-categories";
      }
  ...
  public @ResponseBody
  ResponseEntity<String> pageCategories(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      if (!StringUtils.isBlank(categoryName)) {
        ...
        categoryService
            .listByCodes(store, new ArrayList<String>(Arrays.asList(categoryCode)), language);
  ...
  public String displayCategoryHierarchy(Model model, HttpServletRequest request,
      HttpServletResponse response) throws Exception {
  ...
  public @ResponseBody
  ResponseEntity<String> deleteCategory(HttpServletRequest request, HttpServletResponse response,
      Locale locale) {
  ...
  public @ResponseBody
  ResponseEntity<String> moveCategory(HttpServletRequest request, HttpServletResponse response,
      Locale locale) {
  ...
  public @ResponseBody
  ResponseEntity<String> checkCategoryCode(HttpServletRequest request, HttpServletResponse response,
      Locale locale) {
