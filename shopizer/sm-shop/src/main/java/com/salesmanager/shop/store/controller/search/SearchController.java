...
public class SearchController {
  ...
  public String autocomplete(@RequestParam("q") String query, @PathVariable String store,
    ...
    try {
      ...
      SearchKeywords keywords = searchService
          .searchForKeywords(req.getCollectionName(), req.toJSONString(query),
  ...
  public SearchProductList search(@PathVariable String store, @PathVariable final String language,
      @PathVariable int start, @PathVariable int max, Model model, HttpServletRequest request,
      HttpServletResponse response) {
