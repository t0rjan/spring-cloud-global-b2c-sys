...
public class ShoppingCategoryRESTController {
  ...
  @ResponseBody
  public ReadableCategory getCategory(@PathVariable final String store, @PathVariable Long id,
  ...
  @ResponseBody
  public PersistableCategory createCategory(@PathVariable final String store,
  ...
  public void deleteCategory(@PathVariable final String store, @PathVariable Long id,
