...
public class ReadableOrderSummaryPopulator extends
    AbstractDataPopulator<OrderTotalSummary, ReadableOrderTotalSummary> {
  ...
  @Override
  public ReadableOrderTotalSummary populate(OrderTotalSummary source,
