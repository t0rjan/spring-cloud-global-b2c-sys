...
public class CategoryFacadeImpl implements CategoryFacade {
  ...
  public List<ReadableCategory> getCategoryHierarchy(MerchantStore store,
    ...
    Collections.sort(returnValues, new Comparator<ReadableCategory>() {
      @Override
      public int compare(final ReadableCategory firstCategory,
          final ReadableCategory secondCategory) {
  ...
  private void saveCategory(MerchantStore store, Category c, Category parent)
  ...
  public ReadableCategory getById(MerchantStore store, Long id, Language language)
    ...
    ReadableCategory category = populator
        .populate(categoryModel, new ReadableCategory(), store, language);
