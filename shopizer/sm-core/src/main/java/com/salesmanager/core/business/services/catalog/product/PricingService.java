...
public interface PricingService {
  ...
  /**
   * Calculates the FinalPrice of a Product taking into account all defined prices and possible
   * rebates
   */
  ...
  /**
   * Calculates the FinalPrice of a Product taking into account all defined prices and possible
   * rebates. It also applies other calculation based on the customer
   */
  ...
  /**
   * Calculates the FinalPrice of a Product taking into account all defined prices and possible
   * rebates. This method should be used to calculate any additional prices based on the default
   * attributes or based on the user selected attributes.
   */
   ...
   * Calculates the FinalPrice of a Product taking into account all defined prices and possible
   * rebates. This method should be used to calculate any additional prices based on the default
   * attributes or based on the user selected attributes. It also applies other calculation based on
   * the customer
   */
  FinalPrice calculateProductPrice(Product product,
  ...
  /**
   * Converts a String amount to BigDecimal Takes care of String amount validation
   */
