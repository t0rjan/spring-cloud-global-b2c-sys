 ...
 * point for CMS and take care of following functionalities.
...
public interface ContentService
  ...
  /**
   * Finds content for a specific Merchant for a specific ContentType where content code is like a
   * given prefix in a specific language
   */
  List<Content> getByCodeLike(ContentType type, String codeLike, MerchantStore store,
      Language language);
