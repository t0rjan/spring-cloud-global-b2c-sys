...
public interface SearchService {
  ...
  /**
   * The indexing service for products. The index service must be invoked when a product is created
   * or updated
   */
  ...
  /**
   * Similar keywords based on a a series of characters. Used in the auto-complete functionality
   */
