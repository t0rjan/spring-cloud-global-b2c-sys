...
public class MerchantConfigurationServiceImpl extends
  ...
  public void delete(MerchantConfiguration merchantConfiguration) throws ServiceException {
    MerchantConfiguration config = merchantConfigurationRepository
        .findOne(merchantConfiguration.getId());
    if (config != null) {
      super.delete(config);
    }
  }
  ...
  public MerchantConfig getMerchantConfig(MerchantStore store) throws ServiceException {
    ...
    MerchantConfiguration configuration = merchantConfigurationRepository
        .findByMerchantStoreAndKey(store.getId(), MerchantConfigurationType.CONFIG.name());
