...
public interface ShippingQuoteService extends SalesManagerEntityService<Long, Quote> {
  ...
  /**
   * Each quote asked for a given shopping cart creates individual Quote object in the table
   * ShippingQuote. This method allows the creation of a ShippingSummary object to work with in the
   * services and in the api.
   */
