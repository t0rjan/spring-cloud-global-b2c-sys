...
public interface ShoppingCartService extends SalesManagerEntityService<Long, ShoppingCart> {
  ...
  /**
   * Creates a list of ShippingProduct based on the ShoppingCart if items are virtual return list
   * will be null
   */
   ...
   */
  public ShoppingCart mergeShoppingCarts(final ShoppingCart userShoppingCart,
