...
public class OrderRepositoryImpl implements OrderRepositoryCustom {
  ...
  public OrderList listByStore(MerchantStore store, OrderCriteria criteria) {
    ...
    if (!StringUtils.isBlank(criteria.getCustomerName())) {
      String nameParam = new StringBuilder().append("%").append(criteria.getCustomerName())
          .append("%").toString();
    ...
    if (!StringUtils.isBlank(criteria.getPaymentMethod())) {
      String payementParam = new StringBuilder().append("%").append(criteria.getPaymentMethod())
          .append("%").toString();
