...
public class ImportIntegrationModule {
  ...
  /**
   * Import a specific integration module. Will delete and recreate the module if it already exists
   */
  @Ignore
  //@Test
  public void importSpecificIntegrationModule() throws Exception {
    ...
    File file = new File(
        " /Users/carlsamson/Documents/dev/workspaces/shopizer-master/shopizer/sm-core/src/main/resources/reference/integrationmodules.json");
